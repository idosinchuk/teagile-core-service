...
import com.idosinchuk.teagile.core.service.dto.MailDTO;
import com.idosinchuk.teagile.core.service.dto.UserRequestDTO;
import com.idosinchuk.teagile.core.service.dto.UserResponseDTO;
import com.idosinchuk.teagile.core.service.entity.UserEntity;
import com.idosinchuk.teagile.core.service.producer.QueueProducer;
import com.idosinchuk.teagile.core.service.repository.UserRepository;
import com.idosinchuk.teagile.core.service.service.UserService;
		...
		try {
			...
			if (userEntity != null) {
				customMessageList = ArrayListCustomMessage.setMessage(
						"Currently there is a user with this email. Please try with other email.", HttpStatus.BAD_REQUEST);
				resource = new Resources<>(customMessageList);
